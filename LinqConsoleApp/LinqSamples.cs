    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Task7()
        {
            ...
            {
                EmployeeJob = e.Job,
                Count = Emps.Select(e => e.Job).Count()
            }).GroupBy(e => e.EmployeeJob).ToList();
        }
        ...
        public void Task9()
        {
            var res = Emps.Where(e => e.Job == "Fronted programmer")
        ...
        /// UNION
        /// SELECT "No value", (string)null, (DateTime?)null;
        /// 
        /// </summary>
        public void Task10()
        {
            ...
            var convertedList = list.Select(e => new
            {
                e.Ename,
                e.Job,
                e.HireDate
